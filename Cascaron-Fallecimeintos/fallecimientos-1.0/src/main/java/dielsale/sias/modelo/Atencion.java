 ...
 * atributos del layout, de atención al cliente, 
 * desde la vista. Pero además definimos las 
 * columnas de la base de datos que se va a 
 * leer. Así como el nombre de la tabla.
 * 
 * @author Alejandro Valderrama para Dielsale
 */
@Entity
@Table(catalog = "SIAS", schema = "public", name = "atencion")
